...
def register_app_tools(mcp):
    ...
    def start_app(
        ...
        try:
            ...
            print(f"Failed to start app {package_name}: {str(e)}", file=sys.stderr)
            return False
    ...
    def stop_app(package_name: str, device_id: Optional[str] = None) -> bool:
        ...
        try:
            ...
            print(f"Failed to stop app {package_name}: {str(e)}", file=sys.stderr)
            return False
    ...
    def stop_all_apps(device_id: Optional[str] = None) -> bool:
        ...
        try:
            ...
            print(f"Failed to stop all apps: {str(e)}", file=sys.stderr)
            return False
    ...
    def clear_app_data(package_name: str, device_id: Optional[str] = None) -> bool:
        ...
        try:
            ...
            print(f"Failed to clear app data for {package_name}: {str(e)}", file=sys.stderr)
            return False
